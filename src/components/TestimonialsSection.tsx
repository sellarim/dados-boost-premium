      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-8 justify-center items-stretch">
          <div className="flex-1 flex flex-col items-center">
            <div className="w-full max-w-md p-5 bg-white border rounded-lg shadow-md h-full relative before:content-[''] before:absolute before:-left-5 before:top-4 before:w-2 before:h-8 before:bg-blue-200 before:rounded-r-lg">
          ...
          <div className="flex-1 flex flex-col items-center">
            <div className="w-full max-w-md p-5 bg-white border rounded-lg shadow-md h-full relative before:content-[''] before:absolute before:-left-5 before:top-4 before:w-2 before:h-8 before:bg-green-200 before:rounded-r-lg">
